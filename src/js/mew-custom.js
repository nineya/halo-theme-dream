    ...
    customElements.define(
        ...
        class MewQuote extends MewElement {
            init() {
                ...
                const avatarElem = this.options.avatar ? `<a class="mew-quote-href" target="_blank" ${this.options.href ? `href="${this.options.href}"` : ""}><img class="quote-avatar-hexagon" src="${this.options.avatar}"/></a>` : "";
