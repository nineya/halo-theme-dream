...
<#function rendered_html content>
    ...
    <#list emojis?keys as key>
        <#local content=content?replace('\\[/${key}\\]','<img src="${blog_url!}/themes/dream/source/lib/halo-comment@1.1.4/assets/emoji/${emojis[key]}.png" style="width: 1.6em;height: 1.6em;margin: auto 2px;vertical-align: middle;"/>','ri')>
    </#list>
    <#return content>
</#function>
