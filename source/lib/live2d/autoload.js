try {
    768 < $(window).width() && ($("<link>").attr({href: "/themes/dream/source/lib/live2d/waifu.css?v=1.4.2", rel: "stylesheet", type: "text/css"}).appendTo('head'),
    $('body').append('<div class="waifu"><div class="waifu-tips"></div><canvas id="live2d" class="live2d"></canvas><div class="waifu-tool"><span class="fui-home"></span> <span class="fui-chat"></span> <span class="fui-eye"></span> <span class="fui-user"></span> <span class="fui-photo"></span> <span class="fui-info-circle"></span> <span class="fui-cross"></span></div></div>'),
    $.ajax({url: "/themes/dream/source/lib/live2d/waifu-tips.js?v=1.4.2", dataType:"script", cache: true, success: function() {
            $.ajax({url: "/themes/dream/source/lib/live2d/live2d.js?v=1.0.5", dataType:"script", cache: true, success: function() {
